...
require (
	...
	github.com/docker/docker v0.7.3-0.20180728143547-edac92409a3b
	...
	k8s.io/api v0.0.0-20190311155512-f01a027e4c26 // indirect
	k8s.io/apimachinery v0.0.0-20190312224438-de88ae2d04de // indirect
