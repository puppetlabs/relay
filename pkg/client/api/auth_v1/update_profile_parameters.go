...
type UpdateProfileParams struct {
	...
	*/
	Body *models.UpdateProfileSubmission
...
// WithAccept adds the accept to the update profile params
func (o *UpdateProfileParams) WithAccept(accept string) *UpdateProfileParams {
	o.SetAccept(accept)
	return o
}

// SetAccept adds the accept to the update profile params
func (o *UpdateProfileParams) SetAccept(accept string) {
	o.Accept = accept
}

// WithBody adds the body to the update profile params
func (o *UpdateProfileParams) WithBody(body *models.UpdateProfileSubmission) *UpdateProfileParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update profile params
func (o *UpdateProfileParams) SetBody(body *models.UpdateProfileSubmission) {
	o.Body = body
}
