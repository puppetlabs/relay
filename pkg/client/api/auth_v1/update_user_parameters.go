...
type UpdateUserParams struct {
	...
	*/
	Body *models.UpdateUserSubmission
	/*ID
...
// WithAccept adds the accept to the update user params
func (o *UpdateUserParams) WithAccept(accept string) *UpdateUserParams {
	o.SetAccept(accept)
	return o
}

// SetAccept adds the accept to the update user params
func (o *UpdateUserParams) SetAccept(accept string) {
	o.Accept = accept
}

// WithBody adds the body to the update user params
func (o *UpdateUserParams) WithBody(body *models.UpdateUserSubmission) *UpdateUserParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update user params
func (o *UpdateUserParams) SetBody(body *models.UpdateUserSubmission) {
	o.Body = body
}
