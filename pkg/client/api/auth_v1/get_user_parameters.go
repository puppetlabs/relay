...
// WithAccept adds the accept to the get user params
func (o *GetUserParams) WithAccept(accept string) *GetUserParams {
	o.SetAccept(accept)
	return o
}

// SetAccept adds the accept to the get user params
func (o *GetUserParams) SetAccept(accept string) {
	o.Accept = accept
}
