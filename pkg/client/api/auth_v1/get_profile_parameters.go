...
// WithAccept adds the accept to the get profile params
func (o *GetProfileParams) WithAccept(accept string) *GetProfileParams {
	o.SetAccept(accept)
	return o
}

// SetAccept adds the accept to the get profile params
func (o *GetProfileParams) SetAccept(accept string) {
	o.Accept = accept
}
