...
// WithIntegrationID adds the integrationID to the delete integration params
func (o *DeleteIntegrationParams) WithIntegrationID(integrationID string) *DeleteIntegrationParams {
	o.SetIntegrationID(integrationID)
	return o
}

// SetIntegrationID adds the integrationId to the delete integration params
func (o *DeleteIntegrationParams) SetIntegrationID(integrationID string) {
