...
func (o *GetWorkflowRunLogsOK) Error() string {
	return fmt.Sprintf("[GET /api/workflows/{workflow_name}/runs/{run_number}/logs][%d] getWorkflowRunLogsOK  %+v", 200, o.Payload)
}

func (o *GetWorkflowRunLogsOK) GetPayload() *models.Log {
	return o.Payload
}
