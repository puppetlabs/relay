...
// WithAccept adds the accept to the get integration params
func (o *GetIntegrationParams) WithAccept(accept string) *GetIntegrationParams {
	o.SetAccept(accept)
	return o
}

// SetAccept adds the accept to the get integration params
func (o *GetIntegrationParams) SetAccept(accept string) {
	o.Accept = accept
}
